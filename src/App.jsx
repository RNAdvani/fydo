...
function App() {
  ...
  return (
    <div className='App'>
      ...
      <div className="landing flex text-white ">
            <div className="landing-info lg:w-[50%] h-full flex gap-4 flex-col justify-center p-10">
                ...
                <button className='btn  btn-open shadow-none bg-[#FE3838]' onClick={()=>setOpenModal(true)}>Open</button>
            </div>
